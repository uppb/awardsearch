...
import { memoizeAlaskaSearch, searchAlaskaProvider } from "../../../../../awardwiz/backend/award-alerts/providers/alaska/search.js"
import type { AwardSearchQuery } from "../../../../../awardwiz/backend/award-alerts/types.js"
import type { FlightWithFares } from "../../../../../awardwiz/types/scrapers.js"
import { runScraper } from "../../../../../awardwiz-scrapers/scrapers/alaska.js"
...
describe("memoizeAlaskaSearch", () => {
  it("memoizes identical route/date queries", async () => {
    ...
    const search = vi.fn<[AwardSearchQuery], Promise<FlightWithFares[]>>().mockImplementation(() => deferred.promise)
