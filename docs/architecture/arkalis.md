...
Arkalis is the internal browser automation layer used by AwardSearch scrapers. Its implementation lives under [`arkalis/`](../../arkalis/README.md).
...
The debug CLI entry point is [`awardsearch-scrapers/main-debug.ts`](../../awardsearch-scrapers/main-debug.ts).
