...
- machine-readable: `awardsearch/backend/award-alerts/openapi.json`
- runtime implementation: `awardsearch/backend/award-alerts/http-handlers.ts` and `awardsearch/backend/award-alerts/server.ts`

Operational commands and deployment guidance live in [Award Alerts Operations](../operations/award-alerts-operations.md). Test strategy and verification commands live in [Award Alerts Testing](../testing/award-alerts-testing.md).
