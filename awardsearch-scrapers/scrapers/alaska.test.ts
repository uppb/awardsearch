...
import type { AlaskaResponse } from "../scraper-types/alaska.js"
...
describe("alaska scraper helpers", () => {
  ...
  it("standardizes the current rows-based Alaska response into AwardSearch flights", () => {
    const response = extractAlaskaResponseFromSvelteData(SAMPLE_SVELTE_DATA)
