...
import { AwardSearchQuery, AwardSearchScraper, FlightFare, FlightWithFares } from "../awardsearch-types.js"
...
const standardizeResults = (raw: DeltaResponse, query: AwardSearchQuery) => {
