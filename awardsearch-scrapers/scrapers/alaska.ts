...
import { FlightFare, FlightWithFares, AwardSearchQuery, AwardSearchScraper } from "../awardsearch-types.js"
...
export const buildResultsUrl = (query: AwardSearchQuery) =>
...
export const runScraper: AwardSearchScraper = async (arkalis, query) => {
...
export const standardizeResults = (raw: AlaskaResponse, query: AwardSearchQuery): FlightWithFares[] => {
