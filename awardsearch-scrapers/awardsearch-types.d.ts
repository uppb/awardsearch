...
export type AwardSearchScraperModule = { meta: ScraperMetadata, runScraper: AwardSearchScraper }
export type AwardSearchScraper<ReturnType = FlightWithFares[]> = (req: Arkalis, query: AwardSearchQuery) => Promise<ReturnType>
export type AwardSearchQuery = { origin: string, destination: string, departureDate: string }
