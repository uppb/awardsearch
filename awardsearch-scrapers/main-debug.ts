...
import { AwardSearchQuery, AwardSearchScraperModule } from "./awardsearch-types.js"
...
const scraper = await import(`./scrapers/${scraperName}.js`) as AwardSearchScraperModule
const query: AwardSearchQuery = { origin, destination, departureDate }
